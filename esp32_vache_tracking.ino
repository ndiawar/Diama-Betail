...
const unsigned long updateInterval = 60000; // 1 minute au lieu de 30 secondes
...
void setup() {
  ...
  Serial.println("=== Système Collier RFID DIAMA Initialisé ===");
...
void sendToDiamaServer() {
  ...
  Serial.println("📡 Envoi vers DIAMA...");
